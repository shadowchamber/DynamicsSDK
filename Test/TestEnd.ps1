...
try
{
    ...
    if ($DynamicsSdkPath -and (Test-Path -Path $DynamicsSdkPath))
    {
        ...
        & $InstrumentationScript -TestEnd -BuildNumber $BuildNumber
    }
    else
    {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDOD2s9I2VkdP4v
# Syh9mDZuuz/lvXm+ePSd/nVI5Px/y6CCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg42oVuRug
# NzCf2tBeQQw0p7HOXbCwFfdDitOCSw0B+I0wQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQC2JMIZDOLmIoww85xAl6bOY8H4D/DyljWlIDI13n1Q
# wd/r2JcxeKSpWxQiX9PFQJ7sKIF9+0dpPN44/EZ3PALCCpKN5+KvKAFqbHGZKmwc
# BVJltl4bWKE7o0R6vesunZnnPVeaSEgWLh370CDAZWCEyF6906aYPJptFW0BYe/l
# Blw/EP8GRNyDIqJMyz43U4xkaXofX28Mp6lTSvfK2nNPsW3tTHg3ChoHdehDvmbM
# WJU+D701ZCXEt79dRNxhv60RAp5SeSHL1e7w751/1GafESeJbwUTodNR6qGR+4Yd
# kb2jqoKhuO9mlW8Iu/C6ycJoFMHV0H3Lw5yX42U5eP4xoYIS/jCCEvoGCisGAQQB
# gjcDAwExghLqMIIS5gYJKoZIhvcNAQcCoIIS1zCCEtMCAQMxDzANBglghkgBZQME
# AgEFADCCAVkGCyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEINf1jzTOIx+WoofSVURqaTPgjouaxctR3wbRrrxi
# eAL0AgZgPOsQ3tsYEzIwMjEwMzAzMDMwOTU4LjAzOFowBIACAfSggdikgdUwgdIx
...
# AQQwLwYJKoZIhvcNAQkEMSIEIIIrFSHadm59P2fVsOFIKgYpHudfidP8Rz2iL6CR
# rrSXMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgn6/QhAepLF/7Bdsvfu8G
...
# ySubQv3a7N7Q09Z8nT/LGjANBgkqhkiG9w0BAQsFAASCAQAfweMOk3olXIoI8YOF
# ijp6Mg29ifhQ+QRD21tXlLCZcBDDjqNRlllg8iRiLqowHvn+tcdvrn0YiMCMM9Lk
# oDz3C7uxsQdRLbWq1n+MoxKZZZ2hKWdlzNsE0+dNNoWcr9Hhd0e3rVUt0lBunE8F
# MNCz9OWwBMZllscbe4h29DA9xF0avRP2G3hqfzgXf2Z3dl3UJj3NpOnWIXt7zg+V
# rjfePuc+TMJnf13rnVoP6OEljbqnflMD9yxlsD0Jol/QqxxyJOWe1GRi22x8PoBW
# 0dD/auDtTmYReg5WMK9QNaSAJlMYjJ5OtiPpl4BUYxJWEIPRhSJdx5n0cBRUszMj
# EVfW
